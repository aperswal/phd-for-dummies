...
describe("generalized advantage estimation on a gridworld", () => {
  it(
    "reproduces a run exactly from the same seed and inputs",
    () => {
  ...
  it(
    "never puts gradient on terminal states",
    () => {
  ...
  it(
    "climbs toward optimal under a good value function at lambda 0.96",
    () => {
  ...
  it(
    "lambda 1 stays unbiased even when the value function is wrong (gamma-just)",
    () => {
  ...
  it(
    "lambda 0 on a broken value function is heavily biased and stalls",
    () => {
  ...
  it(
    "a broken low-lambda estimator is far more biased than the unbiased high-lambda one",
    () => {
  ...
  it(
    "recovers when lambda is raised mid-run on a broken value function",
    () => {
  ...
  it(
    "more episodes per batch lower the variance of the advantage estimate",
    () => {
      const few = run(
  ...
  it(
    "resets the policy to uniform on demand",
    () => {
  ...
  it(
    "logs the moment the run reaches near-optimal return",
    () => {
