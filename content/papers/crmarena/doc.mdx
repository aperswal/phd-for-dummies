...
![Four pixel record cards in a row joined by a chain, with the second link snapped in clay-orange and the two cards after it faded gray, showing that one wrong call early in a dependent chain wastes everything that comes after it.](/papers/crmarena/dependency-chain.webp)
