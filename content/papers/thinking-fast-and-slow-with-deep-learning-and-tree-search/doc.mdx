...
![A clay-orange pixel notebook and a sage-green pixel tree pass a baton around an ink loop labelled copy and plan, showing that each round the fast learner copies the stronger planner and the planner then plans with the sharper learner.](https://0bmg2fhv0km08dlk.public.blob.vercel-storage.com/papers/thinking-fast-and-slow-with-deep-learning-and-tree-search/exit-loop.webp)
...
![A sage-green pixel tree with one clay-orange branch lit up and an ink arrow labelled hunch pointing at it, showing the learner's hunch steering where the slow search spends most of its effort.](https://0bmg2fhv0km08dlk.public.blob.vercel-storage.com/papers/thinking-fast-and-slow-with-deep-learning-and-tree-search/uct-bias.webp)
...
![A clay-orange rising path labelled ExIt climbs above a sage-green path, while a flat jagged ink line labelled old stays near the bottom, showing that splitting planning from learning climbs faster and steadier than learning both at once.](https://0bmg2fhv0km08dlk.public.blob.vercel-storage.com/papers/thinking-fast-and-slow-with-deep-learning-and-tree-search/gap-climb.webp)
