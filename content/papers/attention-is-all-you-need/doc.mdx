...
![On the left a single tall clay-orange bar towers over tiny flattened bars while on the right a row of balanced sage bars stands evenly, with a small dial between them marking the scaling step, showing that dividing the scores keeps attention from collapsing onto one word.](https://0bmg2fhv0km08dlk.public.blob.vercel-storage.com/papers/attention-is-all-you-need/scaling.webp)
...
![The sentence 'the cat sat on the mat' as pixel word tiles, with three translucent lenses laid over it in different tones, each lens tracing its own pattern of curved arcs between words, showing that several attention heads read the same sentence through different lenses at once.](https://0bmg2fhv0km08dlk.public.blob.vercel-storage.com/papers/attention-is-all-you-need/multi-head.webp)
