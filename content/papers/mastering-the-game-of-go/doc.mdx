...
![On the left a pixel coach hand points at two or three highlighted points on a board, on the right a calm pixel eye reads a full board with a clay-orange winner bar, showing that the policy network picks moves worth trying while the value network calls who is ahead.](/papers/mastering-the-game-of-go/two-networks.webp)
...
![A balance scale weighing a pixel eye on one pan against a fast pixel rolling die on the other, with the inked pointer resting in the middle, showing that the best estimate of who is winning blends the value network's glance with a quick random playout.](/papers/mastering-the-game-of-go/lambda-mix.webp)
