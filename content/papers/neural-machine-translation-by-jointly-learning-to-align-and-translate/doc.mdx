...
![Two ink curves climb together over a row of pixel sentence bars that grow longer to the right, then the sage fixed-summary curve falls off a cliff past the middle while the clay-orange re-reading curve stays flat and high, showing that the bottleneck breaks on long sentences and re-reading does not.](/papers/neural-machine-translation-by-jointly-learning-to-align-and-translate/length-cliff.webp)
