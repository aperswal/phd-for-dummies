...
![Three pixel-art gears linked in a ring on parchment, one labelled act, one labelled compare, one labelled fit, ink arrows showing trajectories flowing from act to compare and reward flowing from fit back to act, showing the three processes that run at the same time and feed each other.](/papers/deep-reinforcement-learning-from-human-preferences/three-loops.webp)
