...
![A bright clay-orange coin labelled now sits beside a fading row of smaller sage coins labelled later, joined by an ink plus sign and brace into one total, showing that the value of a move is the reward you get now plus a discounted guess of all the score still to come.](https://0bmg2fhv0km08dlk.public.blob.vercel-storage.com/papers/playing-atari-with-deep-reinforcement-learning/bellman.webp)
...
![A wooden box brimming with numbered memory cards while a hand pulls a shuffled handful from the middle and hands it to a practice slate, showing that experience replay studies a random mix of past moments instead of only the very last one.](https://0bmg2fhv0km08dlk.public.blob.vercel-storage.com/papers/playing-atari-with-deep-reinforcement-learning/replay.webp)
